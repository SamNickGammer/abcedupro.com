/** The spinner from resources/views/admin/components/spinner.blade.php. */
export function Spinner({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <div role="status" className="flex items-center justify-center w-full">
      <svg
        aria-hidden="true"
        className={`inline ${className} animate-spin`}
        viewBox="0 0 100 101"
        fill="none"
...
/** A shimmering block, sized by the caller. */
